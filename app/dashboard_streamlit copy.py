...
def criar_grafico_top_vms(df: pd.DataFrame, recurso_selecionado: str = "Todos"):
    """
    Cria gráfico Top 30 VMs por score.
    Ajusta o título e o hover conforme o recurso selecionado.
    """
    ...
    if recurso_selecionado == "CPU":
        ...
        titulo = "Top 30 VMs por score — foco em CPU"
        ...
        titulo = "Top 30 VMs por score — foco em Memória"
        ...
        titulo = "Top 30 VMs por score — foco em Disco"
        ...
        titulo = "Top 30 VMs por score de prioridade"

    hover_data = [c for c in hover_data if c in dados.columns]
...
st.markdown(
    '<div class="subtitle">Dashboard local de Capacity Planning VMware — v0.6</div>',
    unsafe_allow_html=True,
)
...
col7.metric("Risco 30d", risco_30)
col8.metric("Risco 60d", risco_60)
col9.metric("Risco 90d", risco_90)
"""
