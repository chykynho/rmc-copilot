...
| Recurso | Disco (Partição D:) |
| Período histórico | 90 dias |
| Período analisado | 20/03/2026 a 17/06/2026 |
| Solicitante | Alfredo Albertini |
| Analista | Francisco Alves |
| Origem dos dados | streamlit/local_simulado |
| Data de geração | 18/06/2026 22:53 |

---

## 1. Resumo Executivo

A análise do recurso Disco (Partição D:) da VM SRV-DASHPRD01 indica comportamento operacional estável. A capacidade atual é de 179.40 GB, o uso médio foi de 77.44 GB (43.16%) e o P95 ficou em 81.24 GB (45.28%), dentro da margem de segurança de 80%.
...
![A. Comparação e Previsão](graficos/01_DISK_D_comparacao_previsao.png)
### B. Histórico com Média Móvel

![B. Histórico com Média Móvel](graficos/02_DISK_D_media_movel.png)
### C. Decomposição da Série Temporal

![C. Decomposição da Série Temporal](graficos/03_DISK_D_decomposicao.png)
### D. Distribuição de Uso

![D. Distribuição de Uso](graficos/04_DISK_D_histograma.png)
### E. Uso Médio por Hora

![E. Uso Médio por Hora](graficos/05_DISK_D_uso_por_hora.png)
...
Não há indicação de aumento imediato do recurso Disco (Partição D:). A recomendação é manter a configuração atual e continuar o monitoramento periódico.
