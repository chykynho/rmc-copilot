...
A análise do recurso Processamento (CPU) da VM EQX-CAAUTHPRD03 indica possível superdimensionamento. A capacidade atual é de 100.00 %, enquanto o uso médio foi de apenas 1.74 % (1.74%) e o P95 ficou em 1.92 % (1.92%). Não há evidência estatística de necessidade de aumento do recurso neste momento.
...
No período de 15/03/2026 a 13/06/2026, foram analisadas 91 amostras. A capacidade total considerada foi 100.00 % e a margem de segurança de 80% equivale a 80.00 %. Mínimo: 1.56 %; média: 1.74 %; mediana: 1.73 %; P95: 1.92 %; máximo: 2.00 %. Previsões: 30 dias 1.78 % (1.78%), 60 dias 1.79 % (1.79%), 90 dias 1.81 % (1.81%).
...
| Q3 | 1.78 % |
| P95 | 1.92 % (1.92%) |
| Uso máximo | 2.00 % (2.00%) |
| Forecast 30 dias | 1.78 % (1.78%) |
| Forecast 60 dias | 1.79 % (1.79%) |
| Forecast 90 dias | 1.81 % (1.81%) |
